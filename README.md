...
This is an easy and inuitive quiz game that
is suitable for anyone that wishes to test their 
general knowledge.
...
* In order for you to win the game, you have to answer more than 7
  ...
  gift voucher for you to spend at Statiic Online Store.
...
* Download the game folder onto your local machine
...
* Now type 'npm start'. Runs the app in the development mode.
